...
def main():
    ...
    for season in seasons:
        ...
        print(f"Season {season}: {len(matches)} matches returned")
        ...
        print(f"Season {season}: {completed} completed matches")
        print(f"Games stored: {len(games)}")
        print(f"Last 5 games: {games[-5:]}")
